...
function buildBaseSystemPrompt() {
  return [
    ...
    "圆基础性质题必须使用初中圆性质：同圆半径相等、直径所对圆周角是直角、圆的切线垂直于过切点的半径；圆周角与圆心角基础题可使用同弧/等弧所对圆周角相等、同弧圆心角等于圆周角的 2 倍、圆周角是直角则所对弦为直径；弦弧对应题可使用同圆或等圆中等弦对等弧、等弧对等弦；条件不足时不要强行套用圆性质，不要把圆综合复杂题简化成基础圆图。",
  ].join("\n");
}
