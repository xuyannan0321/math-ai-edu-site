...
function buildGeometrySystemPrompt() {
  return [
    ...
    "2. 你可以在 hiddenVerification 中做常量核对、分支检查、双源验算、不变量检查和图文一致性自检，但 hiddenVerification 不得写入学生可见解析。",
    "3. 不要输出 <draft> 标签；把草稿校验结果浓缩到 hiddenVerification JSON 字段。",
